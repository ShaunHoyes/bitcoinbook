...
As above, this appendix describes services offered in the bitcoin economy. Each service is described as a service archetype which is compared to a real-world example familiar to anyone. The description of such a service is followed by real-world examples that express 
